...
export const sessionConfig = {
  ...
  criticalStates: ['facturaGenerada', 'userStatus', 'tenantId'],
...
export function getSessionService() {
  if (sessionConfig.useRedisOnly) {
    return import('../core/auth/redis-only-session.service.js').then((module) => module.default);
  }
  return import('../core/auth/session.service.js').then((module) => module.default);
}
