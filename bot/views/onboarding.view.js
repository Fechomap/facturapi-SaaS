...
export function onboardingProgressView(progress) {
  ...
  if (progress.isCompleted) {
    message += '🎉 *¡Felicidades!* Tu configuración está completa.\nYa puedes usar todas las funciones del sistema.';
  ...
  ].filter(buttons => buttons.length > 0)); // Filtrar filas vacías
...
export function nextStepView(progress) {
  ...
  keyboardButtons.push([Markup.button.callback('📊 Ver progreso completo', 'view_onboarding_progress')]);
