...
-- CreateIndex
CREATE UNIQUE INDEX "tenant_users_telegram_id_key" ON "tenant_users"("telegram_id");
...
-- AddForeignKey
ALTER TABLE "tenant_invoices" ADD CONSTRAINT "tenant_invoices_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "tenant_users"("telegram_id") ON DELETE SET NULL ON UPDATE CASCADE;
