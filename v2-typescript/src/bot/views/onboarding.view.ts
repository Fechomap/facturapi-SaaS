 ...
 * @param progress - Datos de progreso de onboarding
 * @returns Mensaje formateado y teclado
 */
export function onboardingProgressView(progress: OnboardingProgress): ViewResponse {
 ...
 * @returns Mensaje formateado y teclado
 */
export function nextStepView(progress: OnboardingProgress): ViewResponse {
  let nextStep = '';
  let actionButton: Array<ReturnType<typeof Markup.button.callback>> = [];
  ...
  const keyboardButtons: Array<Array<ReturnType<typeof Markup.button.callback>>> = [];
